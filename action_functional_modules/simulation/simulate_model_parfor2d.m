...
% возвращаем только первые две размерности
...
% outs = simulate_model2d(sys, x0, simCount, time, 3)
% toc
% -------------------------------------------------
% 
...
function outs = simulate_model_parfor2d(sys, time, x0, simCount)
outs = zeros(length(time), 2, simCount);
parfor i=1:simCount
...
% походу много памяти надо, если всё это сохранять
